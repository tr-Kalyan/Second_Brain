            ...
            <div className="bg-slate-900 p-10 rounded-lg shadow-lg w-full sm:w-96 text-indigo-300 text-sm">
                ...
                <form>
                    ...
                    <div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
                        ...
                        <input className="bg-transparent outline-none text-white" type="email" placeholder="your@email.com" required />
                    </div>
                    <div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
                    ...
                    <button className="w-full py-2.5 rounded-full bg-gradient-to-r from-indigo-500 to-teal-900 text-white font-medium">{state}</button>
                </form>
